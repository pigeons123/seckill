...
public class SeckillPlaceOrderLockService implements SeckillPlaceOrderService {
    ...
    public Long placeOrder(Long userId, SeckillOrderCommand seckillOrderCommand) {
        ...
        //发送事务消息
        messageSenderService.sendMessageInTransaction(this.getTxMessage(SeckillConstants.TOPIC_TX_MSG, txNo, userId,  SeckillConstants.PLACE_ORDER_TYPE_LOCK, exception, seckillOrderCommand, seckillGoods, 0), null);
        return txNo;
    }
